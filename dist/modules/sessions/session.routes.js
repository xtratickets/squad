...
const sessionController = __importStar(require("./session.controller"));
...
router.post('/:id/pause', auth_middleware_1.authenticate, sessionController.pauseSession);
router.post('/:id/resume', auth_middleware_1.authenticate, sessionController.resumeSession);
